...
namespace QLKS.WebApp
{
    ...
    public class ApplicationUserManager : UserManager<Account>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Account>(context.Get<HotelDbContext>()));
            ...
            manager.RegisterTwoFactorProvider("UserName Code", new EmailTokenProvider<Account>
            {
